...
| removed | V8 and form samples | sample-only | `samples/simple_with_v8.cc` and Formfill setup in `samples/simple_no_v8.c` removed | Samples should reflect the supported light API surface. | Remaining sample demonstrates static document creation without a form environment. |
